Feature: US14
  ...
  Scenario Outline: TC02 Positive test
    ...
    Then The relevant "<zipcode>" is entered into <x> <y> <wait> <xMove> <yMove> the zip code textbox.
    ...
    Examples:
      | fullName | email       | phoneNumber | zipcode | street | x   | y    | wait | xMove | yMove |
      | Elif     | 12@gmail.cm | 12345       | 12345   | 12345  | 701 | 1273 | 750  | 701   | 261   |
  ...
  Scenario Outline: TC03 Negative test
    ...
    Then Scroll down the page with valid <x> <y> <wait> <xMove> <yMove> coordinates
    Then Valid information is entered in the "<street>" textbox.
    Then Tap on the Add address button


    Examples:
      | fullName | phone | street | x   | y    | wait | xMove | yMove |
      | Elif     | 12345 | 123    | 735 | 1283 | 750  | 735   | 648   |